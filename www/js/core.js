...
(function() {
    var config = {
        ...
        paths: {
            ...
            pageSwitch: 'libs/pageSwitch/src/pageSwitch',
...
(function (ROOT, struct, undefined) {
    ...
    CONFIG['growth'] = [
        'width:0;transform:translateX(0px);height:0',
    ...
    CONFIG['flyLeftBottomIn'] = [
        'transform:translate(-50%,50%);',
        'transform:translate(0,0);'
    ];
    CONFIG['flyRightTopIn'] = [
        'transform:translate(50%,-50%);',
        'transform:translate(0,0);'
    ];
...
define('utils', [
    ...
    var K = {
        ...
        isMobile: function () {
            return K.screen == 'small';
        },
        isPad: function () {
            return K.screen == 'medium';
        }
    };
    function camelCase(str) {
        return str.replace(/^-ms-/, 'ms-').replace(/-([a-z]|[0-9])/gi, function (all, letter) {
    ...
    supports.file = typeof File != 'undefined' && typeof FileReader != 'undefined';
    testStyle.cssText = 'color:rgba(0,0,0,.6);position:fixed;_position:absolute;display:inline-block;*display:inline;border-color:transparent;' + K.fixCSS('transform-style') + ':preserve-3d;background-image:' + K.cssVendor + 'gradient(linear,0 0,0 0,from(#000),to(#000));background-image:' + K.cssVendor + 'linear-gradient(#fff,#000);';
    ...
    (function () {
        var ret = {
            medium: '(max-width: 780px) and (min-width: 580px)',
