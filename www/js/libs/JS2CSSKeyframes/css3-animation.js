...
(function(ROOT, struct, undefined){
    ...
    var CONFIG={
        ...
        rotate_360:['','transform:rotate(-360deg)']
    };
    ...
    CONFIG['growth']=['width:0;transform:translateX(0px);height:0','width:100%;transform:translateX(0);'];
    CONFIG['shining']=['opacity:0','opcaity:1'];

    CONFIG['flyLeftBottomIn']=['transform:translate(-50%,50%);','transform:translate(0,0);'];
    CONFIG['flyRightTopIn']=['transform:translate(50%,-50%);','transform:translate(0,0);'];
